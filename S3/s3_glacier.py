...
# Common Variables
LIFECYCLE_DAYS = 180  # Set how many days after which objects should transition to Glacier
...
def create_lifecycle_policy(bucket_name, s3_client, profile):
    """Create the S3 lifecycle policy to transition objects to Glacier after X days and leave them there."""
